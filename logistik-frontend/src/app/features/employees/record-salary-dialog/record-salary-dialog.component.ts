      ...
      @if (!calc()) {
        <form [formGroup]="form" class="dialog-form">
          ...
          <mat-form-field appearance="outline" class="full-width">
            ...
            <mat-hint>{{ 'salary.salaryDefault' | translate: {amount: (data.netSalary | number:'1.0-0':'mk')} }}</mat-hint>
          </mat-form-field>
        ...
        <div class="summary-panel">
          ...
          <div class="calc-grid">
            <div class="calc-row">
              ...
              <span class="calc-value">{{ calc()!.order.totalAmount | number:'1.0-0':'mk' }} ден.</span>
            </div>
            <div class="calc-row">
              <span class="calc-label">{{ 'salary.totalPaidSoFar' | translate }}</span>
              <span class="calc-value">{{ calc()!.order.totalPaid | number:'1.0-0':'mk' }} ден.</span>
            </div>
            <div class="calc-row emphasis">
              <span class="calc-label">{{ 'salary.paymentThisMonth' | translate }}</span>
              <span class="calc-value red">{{ calc()!.monthlyDeduction | number:'1.0-0':'mk' }} ден.</span>
            </div>
            <div class="calc-row emphasis total-row">
              ...
              <span class="calc-value" [class.green]="calc()!.order.remainingAmount <= 0" [class.red]="calc()!.order.remainingAmount > 0">
                {{ calc()!.order.remainingAmount | number:'1.0-0':'mk' }} ден.
              </span>
            </div>
          </div>
